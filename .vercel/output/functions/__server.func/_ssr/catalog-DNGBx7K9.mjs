//#region node_modules/.nitro/vite/services/ssr/assets/catalog-DNGBx7K9.js
var NAV = [
	{
		to: "/shop",
		label: "Shop"
...
var products = [
	{
		...
		description: "A single NFC charm in pearlescent white enamel with a silver tap disc inset. Trade it, leave it on a lanyard, or sew it into a jacket. Battery-free, water-resistant, and readable by any modern phone. Pack of two.",
		variants: [{
			id: "milk",
			name: "Milk",
			available: true
	...
	},
	{
		...
		gallery: [
			"/products/heart.jpg",
			"/products/bracelet.jpg",
			"/images/afters.jpg"
		],
		category: "charms",
		blurb: "Two hands, one heart, a disc you can actually tap.",
		description: "Dusty-rose enamel hands meeting at a hidden NFC disc. The charm that gets passed between people who actually mean it. Pack of two.",
		variants: [{
			id: "rose",
			name: "Rose",
			available: true
	...
	},
	{
		...
		description: "A black cotton bucket with a removable TapThat enamel pin. The drop is closed. Join the list for the next run.",
		variants: [{
			id: "os",
			name: "One size",
			available: false
	...
	},
	{
		...
		description: "A circular cream-and-terracotta sunburst with a silver NFC core. Named for the nights you want to keep, not the ones you post. Pack of two.",
		variants: [{
			id: "rose",
			name: "Rose",
			available: true
	...
	},
	{
		...
		gallery: [
			"/products/pack-10.jpg",
			"/products/pack-5.jpg",
			"/products/pack-3.jpg"
		],
		category: "packs",
		blurb: "Enough to trade a whole weekend and still keep one.",
		description: "Ten mixed enamel NFC charms. Mixed shapes, one silver tap disc each, packed for a cruise week, a resort takeover, or a friend group that actually shows up. Battery-free and water-resistant.",
		variants: [
			{
				id: "mixed",
				name: "Mixed",
	...
	},
	{
		...
		description: "Three enamel NFC charms. The starter pack: keep one, trade one, follow the third. Works with any modern smartphone.",
		variants: [
			{
				id: "mixed",
				name: "Mixed",
	...
	},
	{
		...
		description: "Five mixed enamel NFC charms for a crew. Trade across a night and watch the journeys split in the app.",
		variants: [
			{
				id: "mixed",
				name: "Mixed",
	...
	},
	{
		...
		description: "Hand-tied black cord with three live NFC charms already on it. Wear it, tap it, trade a charm off it. One size, knots adjust.",
		variants: [{
			id: "ink",
			name: "Ink cord",
			available: true
	...
	},
	{
		...
		description: "Chunky pineapple NFC charms with a silver tap disc. The sign people actually look for on a cruise, a resort, or a pineapple weekend. Pack of two.",
		variants: [{
			id: "slick",
			name: "Slick",
			available: true
...
var posts = [
	{
		...
		body: ["Pineapple Week always empties the drawer. This year we held a two-day flash on the 10-pack and opened bulk quotes for rooms that want a charm on every wristband.", "If you’re ordering for a house, a label, or a commemorative night, the Partner desk still starts at 200 units. The rest of us can just tap what’s already in the shop."]
	},
	{
		slug: "squad-update",
		...
		body: ["Squad is how we stay honest. Ambassadors get early colorways, a private channel, and a job: tap in rooms we can’t be in, write what happened, and send the charm on.", "Applications stay open. We read every note. We do not ask for follower counts."]
	},
	{
		...
		image: "/images/tap.jpg",
		body: ["Phone numbers die in notes apps. A charm you both tapped does not. Leave a memory, keep it private, and the next time that disc is scanned you’re both still in the thread.", "Public charms are for journeys. Private charms are for the table. Use both."]
	},
	{
		...
		image: "/images/afters.jpg",
		body: ["People have always left proof they were in the same room. A setlist, a pin, a braided cord. TapThat is that instinct with a memory attached.", "The disc does not replace the object. It lets the object keep talking after you go home."]
	},
	{
		...
		image: "/products/bracelet.jpg",
		body: ["One charm on a black cord is enough. Two if they’re a pair. A full stack reads as a stall, not a night.", "Pin the ghost to a jacket lining if you want it found. Put LIVE on the outside if you want it tapped."]
	}
];
var ambassadors = [
	{
...
function memoriesFor(charmId) {
	return memories.filter((m) => m.charmId === charmId).sort((a, b) => +new Date(b.at) - +new Date(a.at));
}
...
function relatedProducts(slug, n = 3) {
	...
	return products.filter((p) => p.slug !== slug && (!current || p.category === current.category || p.featured)).slice(0, n);
}
//#endregion
export { events as a, memories as c, posts as d, productBySlug as f, charms as i, memoriesFor as l, relatedProducts as m, ambassadors as n, faqs as o, products as p, charmById as r, howSteps as s, NAV as t, postBySlug as u };
