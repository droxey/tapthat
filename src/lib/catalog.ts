...
export type PineappleLink = {
  name: string;
  url: string;
  note?: string;
};

export type PineappleGroup = {
  title: string;
  links: PineappleLink[];
};

export const pineapplePartners: PineappleGroup[] = [
  {
    title: "Cruises / Resorts / Pineapple",
    links: [
      { name: "Desire Vacations", url: "https://www.desirevacations.com/" },
      { name: "Temptation Resorts", url: "https://www.temptationresorts.com/" },
      { name: "Hedonism II", url: "https://www.hedonism.com/" },
      { name: "Bliss Cruise", url: "https://www.blisscruise.com/" },
      { name: "Caliente Resort", url: "https://www.calienteresort.com/" },
    ],
  },
  {
    title: "ENM / Lifestyle / Kink",
    links: [
      { name: "FetLife", url: "https://fetlife.com/", note: "profile link" },
      { name: "Feeld", url: "https://feeld.co/" },
      { name: "SDC", url: "https://www.sdc.com/" },
      { name: "SLS", url: "https://www.swinglifestyle.com/" },
      { name: "Kasidie", url: "https://www.kasidie.com/" },
      { name: "AdultFriendFinder", url: "https://adultfriendfinder.com/", note: "profile link" },
      { name: "3Fun", url: "https://www.go3fun.co/" },
      { name: "Pure", url: "https://pure.app/" },
      { name: "#Open", url: "https://hashtagopen.com/" },
      { name: "Polyfinda", url: "https://polyfinda.com/" },
      { name: "Collarspace", url: "https://www.collarspace.com/", note: "profile link" },
      { name: "Fetish.com", url: "https://fetish.com/" },
      { name: "Alt.com", url: "https://www.alt.com/" },
      { name: "SwingTowns", url: "https://www.swingtowns.com/" },
      { name: "FabSwingers", url: "https://www.fabswingers.com/", note: "profile link" },
      { name: "Recon", url: "https://www.recon.com/", note: "profile link" },
    ],
  },
  {
    title: "Sugar",
    links: [
      { name: "Seeking", url: "https://seeking.com/" },
      { name: "Secret Benefits", url: "https://secretbenefits.com/" },
      { name: "Sugarbook", url: "https://sugarbook.com/" },
      { name: "SugarDaddyMeet", url: "https://www.sugardaddymeet.com/" },
    ],
  },
  {
    title: "Cam",
    links: [
      { name: "Chaturbate", url: "https://chaturbate.com/", note: "profile link" },
      { name: "Stripchat", url: "https://stripchat.com/", note: "profile link" },
      { name: "MyFreeCams", url: "https://www.myfreecams.com/", note: "profile link" },
      { name: "BongaCams", url: "https://bongacams.com/", note: "profile link" },
      { name: "LiveJasmin", url: "https://www.livejasmin.com/", note: "profile link" },
    ],
  },
  {
    title: "Creators",
    links: [
      { name: "OnlyFans", url: "https://onlyfans.com/", note: "profile link" },
      { name: "Fansly", url: "https://fansly.com/", note: "profile link" },
      { name: "Pornhub", url: "https://www.pornhub.com/", note: "profile link" },
      { name: "XVideos", url: "https://www.xvideos.com/" },
      { name: "xHamster", url: "https://xhamster.com/", note: "profile link" },
      { name: "ManyVids", url: "https://www.manyvids.com/", note: "profile link" },
    ],
  },
  {
    title: "Apps",
    links: [
      { name: "Tinder", url: "https://tinder.com/", note: "profile link" },
      { name: "Bumble", url: "https://bumble.com/" },
      { name: "Grindr", url: "https://www.grindr.com/" },
      { name: "Ashley Madison", url: "https://www.ashleymadison.com/" },
      { name: "OkCupid", url: "https://www.okcupid.com/" },
      { name: "Badoo", url: "https://badoo.com/" },
      { name: "DOWN", url: "https://downapp.com/" },
    ],
  },
];
