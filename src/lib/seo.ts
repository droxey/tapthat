...
export const DEFAULT_DESCRIPTION =
  "Tap that. Follow the rest. Beads for cruises, resorts, pineapple weekends.";
...
export const DEFAULT_OG_TITLE = "TapThat. Beads for cruises, resorts, pineapple weekends.";
...
export function socialHead({
  ...
  imageAlt = "TapThat. Beads for cruises, resorts, pineapple weekends.",
  type = "website",
  shareTitle,
}: SocialHeadInput) {
